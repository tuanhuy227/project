<?php
    ...
    */
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        if ($size == '')
        {
            $error['size'] = " Size không được để trống !";
        }
                    ...
                    <form role="form" method="POST" class="form-horizontal ng-pristine ng-valid" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-body ">
                            ...
                            <div class="col-md-9 bor">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-2"> Loại sản phẩm  <span class="required">(*)</span></label>
                                    <div class="col-md-10">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-2" for="first-name"> Tên <span class="required">(*)</span>
                                    </label>
                                    <div class="col-md-10">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-2" for="first-name"> Size <span class="required">(*)</span>
                                    </label>
                                    <div class="col-md-10">
                                        <input type="text" name="size" required class="form-control col-md-7 col-xs-12" value="<?php echo $productEdit['size'] ?>">
                                        <p><i>Các size cách nhau bởi dấu ','</i></p>
                                    </div>
                                </div>
                                <div class="form-group">

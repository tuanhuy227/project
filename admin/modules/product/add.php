...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($danhmuc_id == '') {
        $error['danhmuc_id'] = " Loại sản phẩm không được để trống !";
    }
                    ...
                    <div class="form-body ">
                        <form id="demo-form2" action="" method="POST" class="form-horizontal form-label-left bor"
                            ...
                            <div class="col-md-9 bor">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-2"> Loại sản phẩm <span
                                                class="required">(*)</span></label>
                                    <div class="col-md-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="size" required class="form-control col-md-7 col-xs-12"
                                               value="">

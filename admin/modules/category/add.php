                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="tendanhmuc" value="<?php echo isset($tendanhmuc) ? $tendanhmuc : '' ?>" class="form-control has-maxlength" placeholder="Tên loại sản phẩm" maxlength="200">
                                        </div>
                                    </div>                                   
